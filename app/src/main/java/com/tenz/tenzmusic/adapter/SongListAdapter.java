...
public class SongListAdapter extends BaseQuickAdapter<SongBean> {

    private Option mOption;

    public SongListAdapter(Context context, int layoutResID, List<SongBean> data, Option option) {
    ...
    public void convert(BaseViewHolder holder, SongBean item) {
        ...
        tv_singer.setText(item.getFilename().split(" ")[0]);
