...
public class SpUtil {
    ...
    private static String mPreferencesName = Constant.SP_NAME;
    ...
    public static <T> void setDataList(String key, List<T> datalist) {
        ...
        SpUtil.putString(App.getContext(), key, strJson);
    }
    ...
    public static <T> List<T> getDataList(String key, Class<T> cls) {
        ...
        String strJson = SpUtil.getString(App.getContext(), key, null);
        if (null == strJson) {
            return datalist;
        }
        try {
