...
public class StringUtil {
     ...
     * @return
     */
    public static final String handlerResponseString(String data) {
        if (TextUtils.isEmpty(data)) {
            return data;
        }
        if (data.contains("<!--KG_TAG_RES_START-->")) {
            data = data.replaceAll("<!--KG_TAG_RES_START-->","");
        }
        if (data.contains("<!--KG_TAG_RES_END-->")) {
            data = data.replaceAll("<!--KG_TAG_RES_END-->","");
        }
        if (data.contains("jQuery1910818988551264608_1610613407119(")) {
            data = data.replaceAll("jQuery1910818988551264608_1610613407119\\(","");
        }
        if (data.contains(");")) {
