...
public class FullScreenPlayer extends AbsPlayer implements View.OnClickListener,
    ...
    private com.tencent.liteav.superplayer.model.utils.VideoGestureDetector mVideoGestureDetector;                      // 手势控制工具
    ...
    private void initialize(Context context) {
        ...
        mVideoGestureDetector = new com.tencent.liteav.superplayer.model.utils.VideoGestureDetector(getContext());
        mVideoGestureDetector.setVideoGestureListener(new com.tencent.liteav.superplayer.model.utils.VideoGestureDetector.VideoGestureListener() {
            @Override
