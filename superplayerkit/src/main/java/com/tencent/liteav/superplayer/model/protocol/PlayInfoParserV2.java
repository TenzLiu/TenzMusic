...
public class PlayInfoParserV2 implements IPlayInfoParser{
    ...
    private List<com.tencent.liteav.superplayer.model.entity.VideoClassification> mVideoClassificationList;     // 视频清晰度信息列表
     ...
     * @return 视频清晰度信息数组
     */
    private List<com.tencent.liteav.superplayer.model.entity.VideoClassification> parseVideoClassificationList(JSONObject playerInfo) throws JSONException {
        List<com.tencent.liteav.superplayer.model.entity.VideoClassification> arrayList = new ArrayList<>();
        ...
        if (videoClassificationArray != null) {
            for (int i = 0; i < videoClassificationArray.length(); i++) {
                ...
                com.tencent.liteav.superplayer.model.entity.VideoClassification classification = new com.tencent.liteav.superplayer.model.entity.VideoClassification();
        ...
        for (int i = 0; i < transcodeList.size(); i++) {
            ...
            if (mVideoClassificationList != null) {
                for (int j = 0; j < mVideoClassificationList.size(); j++) {
                    com.tencent.liteav.superplayer.model.entity.VideoClassification classification = mVideoClassificationList.get(j);
