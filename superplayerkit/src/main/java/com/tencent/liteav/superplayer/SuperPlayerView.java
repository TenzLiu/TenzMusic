...
public class SuperPlayerView extends RelativeLayout {
    ...
    private com.tencent.liteav.superplayer.ui.player.FloatPlayer mFloatPlayer;                              // 悬浮窗模式控制view
    ...
    private com.tencent.liteav.superplayer.model.utils.NetWatcher mWatcher;                         // 网络质量监视器
    ...
    private void initView() {
        ...
        mFloatPlayer = (com.tencent.liteav.superplayer.ui.player.FloatPlayer) mRootView.findViewById(R.id.superplayer_controller_float);
    ...
    private void initPlayer() {
        ...
        if (mWatcher == null) {
            mWatcher = new com.tencent.liteav.superplayer.model.utils.NetWatcher(mContext);
        }
    }
